...
def train(lr_pre,lr_sr):
    ...
    rmses = [np.inf]
    # p_save_path = 'saved_model/to_stage/no_ext(f)/{}/{}_{}/-4-6/{}-{}-{}_{}{}{}_{}_{}/cpt'.format(opt.dataset,
    ...
    p_save_path = 'saved_model/to_stage/no_ext(f+r)/{}/{}_{}/-4-6/{}-{}-{}_{}{}{}_{}_{}/cpt'.format(opt.dataset,
                                                                                      ...
                                                                                      opt.n_heads,
                                                                                      opt.num_layers)
    # g_save_path = 'saved_model/to_stage/no_ext(f)/{}/{}_{}/-4-6/{}-{}-{}_{}{}{}_{}_{}/Generator'.format(opt.dataset,
    ...
    g_save_path = 'saved_model/to_stage/no_ext(f+r)/{}/{}_{}/-4-6/{}-{}-{}_{}{}{}_{}_{}/Generator'.format(opt.dataset,
                                                                                      ...
                                                                                      opt.n_heads,
                                                                                      opt.num_layers)
    # d_save_path = 'saved_model/to_stage/no_ext(f)/{}/{}_{}/-4-6/{}-{}-{}_{}{}{}_{}_{}/Discriminator'.format(opt.dataset,
    ...
    # p_pretrain_path = 'saved_model/separate/{}/cpt_noext/{}-{}-{}_{}_{}_{}'.format(opt.dataset,
                                                               opt.len_closeness,
                                                               opt.len_period,
                                                               opt.len_trend,
                                                               opt.n_heads,
    ...
    train_dataloader = get_dataloader(
        datapath, opt.len_closeness, opt.len_period, opt.len_trend, opt.scaler_X, opt.scaler_Y, opt.batch_size,False,
        'train',map_H=opt.map_height,map_W=opt.map_width,day_len=24,channel=opt.nb_flow)  # opt.batch_size=16
    valid_dataloader = get_dataloader(
        datapath, opt.len_closeness, opt.len_period, opt.len_trend, opt.scaler_X, opt.scaler_Y, 4, False,
        'valid',map_H=opt.map_height,map_W=opt.map_width,day_len=24,channel=opt.nb_flow)
    ...
    netS = Generator(scale_factor=opt.upscale_factor, n_residual_block=opt.n_residuals, base_channel=opt.base_channels,
                     scaler_x=opt.scaler_X, scaler_y=opt.scaler_Y, ext_flag=False,residual_flag=False,in_channel=opt.nb_flow)
